...
func (p *OpenAPI31Parser) setConfig(cfg ParserConfig) {
	p.config = cfg
}
...
func (p *OpenAPI31Parser) ParseSpec(spec []byte) ([]ir.HTTPRoute, error) {
	...
	converter := newSchemaConverter(p.resolver, false)
...
func (p *OpenAPI31Parser) convertRequestBody(requestBody *v3.RequestBody) *ir.RequestBodyInfo {
	...
	if requestBody.Content != nil {
		for mediaType, mediaTypeObj := range requestBody.Content.FromOldest() {
			...
			if encodings := convertEncodings(mediaTypeObj.Encoding, false); len(encodings) > 0 {
...
func (p *OpenAPI31Parser) convertCallbacks(callbacks *orderedmap.Map[string, *v3.Callback]) []ir.CallbackInfo {
...
func (p *OpenAPI31Parser) convertCallbackOperations(pathItem *v3.PathItem) []ir.CallbackOperation {
...
func (p *OpenAPI31Parser) resolveCallback(callback *v3.Callback) *v3.Callback {
	if callback == nil {
		return nil
	}
	low := callback.GoLow()
...
func (p *OpenAPI31Parser) resolveCallbackPathItem(pathItem *v3.PathItem) *v3.PathItem {
	if pathItem == nil {
		return nil
	}
	low := pathItem.GoLow()
...
func (p *OpenAPI31Parser) convertSchema(schema interface{}) ir.Schema {
	...
	return ConvertToJSONSchema(converted, false)
}
